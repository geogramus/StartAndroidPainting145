...
class DrawPolyToPoly2Dots(context: Context) : View(context) {
    ...
    var src = floatArrayOf(100f, 100f, 200f, 200f)
    var dst = floatArrayOf(50f, 300f, 250f, 500f)
    var dst2 = floatArrayOf(400f, 200f, 500f, 200f)
    var points = 2
